...
import service from '../Content/services.js';
...
const ServiceHeader = () => {
  ...
  const [headerTitle, setHeaderTitle] = useState("الخدمات الإلكترونية");
  ...
  useEffect(() => {
    const updateHeaderTitle = () => {
      ...
      switch (currentPath) {
        case '/Service':
          setHeaderTitle("الخدمات الإلكترونية");
          break;
        case '/Service/1':
          setHeaderTitle(" إذن إنتاج و تصدير مواد إتفاقية حظر الأسلحة الكيميائية ");
          break;
        case '/Service/2':
          setHeaderTitle("اذن استيراد مواد كيميائية مقيدة");
          break;
        case '/Service/3':
          setHeaderTitle("طلب تأييد عمالة");
          break;
        case '/Service/4':
          setHeaderTitle("تجديد الترخيص");
          break;
        case '/Service/5':
          setHeaderTitle("اعفاء جمركي مواد");
          break;
        case '/Service/6':
          setHeaderTitle("إلغاء الترخيص");
          break;
        case '/Service/7':
          setHeaderTitle("نقل الملكية");
          break;
        case '/Service/8':
          setHeaderTitle("تغيير نوع الاستثمار");
          break;
        case '/Service/9':
          setHeaderTitle("اعفاء جمركي معدات وقطع غيار");
          break;
        case '/Service/10':
          setHeaderTitle("خدمة الاعلانات السنوية");
          break;
        case '/Service/11':
          setHeaderTitle("تعديل الترخيص");
          break;
        case '/Service/12':
          setHeaderTitle("بنود التعرفة المقيدة");
          break;
        case '/Service/13':
          setHeaderTitle("تقديم طلب بدل مغادرين");
          break;
        case '/Service/14':
          setHeaderTitle("التقديم على برنامج تنافسية القطاع الصناعي");
          break;
        case '/Service/15':
          setHeaderTitle("تقديم طلب مواد الخام والبتروكيماويات المتعثرة");
          break;
        case '/Service/16':
          setHeaderTitle("شهادة المنشأ");
          break;
          ...
          <div className="container mx-auto px-4">
            <nav className="text-gray-400 text-sm mb-2">
              <ol className="list-reset flex">
                <li className="text-white"> <a href="/Service"> الخدمات الإلكترونية </a></li>
